...
getPrefix(){
	inet_first=$(echo $inet|cut -d "." -f1)
	inet_second=$(echo $inet|cut -d "." -f2)
	inet_third=$(echo $inet|cut -d "." -f3)
	inet_fourth=$(echo $inet|cut -d "." -f4)
	
	netmk_first=$(echo $netmask|cut -d "." -f1)
	netmk_second=$(echo $netmask|cut -d "." -f2)
	netmk_third=$(echo $netmask|cut -d "." -f3)
	netmk_fourth=$(echo $netmask|cut -d "." -f4)
